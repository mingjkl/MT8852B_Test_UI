'''
Author: emmovo
Date: 2023-04-24 13:42:06
LastEditors: emmovo
LastEditTime: 2023-04-25 11:38:19
FilePath: \demo\http_demo.py
Description: 
...
def mes_status_put(sn_code, user_info):
    ...
    array = {
        ...
        "lineName" : "聚明 A01",                # 产线
        "machineCode" : "01",                     # 机台号
        "moNumber" : "300000037661",            # 工单号     ## 确认会不会变更 ## 300000037661
        "modelName" : "210201A00752",           # 产品料号   ## 确认会不会变更
